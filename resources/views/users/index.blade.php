    ...
    <div class="card-body">
        ...
        <table class="table table-striped table-bordered">
            <thead>
                ...
                <th scope="col">Requested Roles</th>
                            ...
                            @else
                                ...
                                @can('delete-user')
                                    @if (Auth::user()->id!=$user->id)
                                        <button style="background-color:red; color:white;" type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Do you want to delete this user?');"><i class="bi bi-trash"></i> Delete</button>
                                    @endif
                                @endcan
                            @endif
